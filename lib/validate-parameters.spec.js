...
describe('validateParameters', () => {
  ...
  it('should forbid any non-http(s) protocol', () => {

    let params = validParams();
    params.protocol = 'ftp';
    assert.throws(() => validateParameters(params), /protocol.*https?/);
  ...
  it('should set the path to root if the https protocol is used but no path is specified', () => {
